# printTeam.py -- purely for printing + debugging
# ---------
...
class OffensiveReflexAgent(DefaultAgent):
    ...
    def getFeatures(self, gameState, action):
        ...
        print("agent 0: " + str(gameState.getAgentPosition(0)))
        print("agent 1:" + str(gameState.getAgentPosition(1)))
        print("agent 2:" + str(gameState.getAgentPosition(2)))
        print("agent 3:" + str(gameState.getAgentPosition(3)))
